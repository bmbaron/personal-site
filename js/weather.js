...
function getWeatherAndDisplay() { 
  ...
  var website = 'https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?units=metric&lat=' + coordinates[0] + '&lon=' + coordinates[1] + '&APPID=eaf607284a508b29627f7369b57bc03d&callback=?';
  website = '"' + website + '"';
  alert(website);
